...
const labels = {
  pt: {
    ...
    materials: [
      { title: "Menu de Cachoeiras", link: "/cachoeiras" },
      { title: "Curadoria de Hospedagens", link: "/hospedagens" },
      { title: "Experiências Extras", link: "/experiencias" },
      { title: "Serviços Adicionais", link: "/servicos" },
    ],
  ...
  en: {
    ...
    materials: [
      { title: "Waterfall Menu", link: "/cachoeiras" },
      { title: "Accommodation Curation", link: "/hospedagens" },
      { title: "Extra Experiences", link: "/experiencias" },
      { title: "Additional Services", link: "/servicos" },
    ],
  ...
  es: {
    ...
    materials: [
      { title: "Menú de Cascadas", link: "/cachoeiras" },
      { title: "Curaduría de Hospedajes", link: "/hospedagens" },
      { title: "Experiencias Extras", link: "/experiencias" },
      { title: "Servicios Adicionales", link: "/servicos" },
    ],
