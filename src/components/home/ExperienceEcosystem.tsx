...
const differentials = [
  {
    ...
    image: optimizedUrl("home/Curadoria360.png", IMAGE_PRESETS.thumbnail),
    color: "bg-[#744404]/10 text-[#744404]"
  },
  {
    title: "Rede de Parceiros",
    description: "Parceiros locais escolhidos a dedo: hospedagens, restaurantes e experiências.",
    image: optimizedUrl("home/RedeParceiros.png", IMAGE_PRESETS.thumbnail),
  ...
  },
  {
    ...
    image: optimizedUrl("home/ConteudoEstetica.png", IMAGE_PRESETS.thumbnail),
  ...
  },
  {
    ...
    image: optimizedUrl("home/SustentabilidadeLocal.png", IMAGE_PRESETS.thumbnail),
  ...
  },
  {
    ...
    image: optimizedUrl("home/ExperienciasComProposito.png", IMAGE_PRESETS.thumbnail),
...
const pillars = [
  {
    id: "acao",
    title: "AÇÃO",
    description: "Vivências que convidam o turista a agir, interagir com a natureza e se integrar à cultura e à comunidade local",
    ...
    <div className="bg-[#FAF9F6]">
      ...
      <section className="relative py-40 overflow-hidden min-h-[70vh] flex items-center bg-[#141C15]">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src={optimizedUrl("home/exclusividade-rocks.jpg", IMAGE_PRESETS.large)}
          ...
          <div className="flex flex-wrap lg:flex-nowrap justify-center gap-8 md:gap-10 lg:gap-12 relative z-10">
            {pillars.map((pillar, index) => (
              ...
              >
                ...
                <div className="mb-[-20px] relative transition-transform duration-500 group-hover:scale-110 flex items-center justify-center h-64">
                  <div 
                    style={{ 
                      ...
                      width: `${240 * (pillar.scale || 1)}px`,
                      height: `${240 * (pillar.scale || 1)}px`
                    }}
                    role="img"
